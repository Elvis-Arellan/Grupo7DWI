...
<form method="post" action="${pageContext.request.contextPath}/ventas" id="formVenta">
    ...
    <%-- Select para elegir producto a agregar --%>
    <label>Producto:
    ...
    <%-- Inputs ocultos que se envían al servlet --%>
...
<script>
    // Guarda los productos agregados en memoria
    var detalle = [];
    ...
    function agregarProducto() {
        ...
        var existente = detalle.find(function(d) { return d.idProducto === idProducto; });
        if (existente) {
    ...
    function renderTabla() {
        ...
        detalle.forEach(function(d, i) {
            ...
            // Inputs ocultos para el servlet
            ocultos.innerHTML +=
